...
document.querySelector('#pupTraing_iPhone').addEventListener('keypress', (e) => {
  if (e.code.match(/(Digit)|(Numpad)/i) === null && e.code.match('Backspace') === null || e.target.value.length > 6) {
    e.preventDefault()
  }
})
